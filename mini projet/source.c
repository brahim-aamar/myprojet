...
#include <conio.h>
#include <locale.h>
 // declarer mon header file pour declarer les fonctions rt structs 
#include "header.h"
#define max 1000
...
// apres definier touts les structures utiliser  dans header.h .
  // les  fonctions .
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 int menuPrincipal()
{
    int choix;
// pour un ligne double on utilise cette maniere.
...
//*************************** FONCTIONS DE CAS DE GESTION DES VOITURES *******************************************************************
...
//*************************** LES FONCTIOND DE CAS DE GESTION DES CLIENTS ********************************************************************
...
// // CODER PAR : MHAND MAOUS	liste=(FILE*)malloc(sizeof(FILE*));
 ...
 //********************************* FONCTIONS DE CAS DE LOCATION D'UN VOITURES ********************************************************
			...
			if( liste != NULL)
				{
					...
					do{
						...
						if(DEN == ct.numContrat)
						{
							...
							duree = days(ct.debut,ct.fin);
							if (duree<0) // pour vIrifier est ce que la date est valide ;
							{
								dateTemp = ct.fin;
								ct.fin = ct.debut;
								ct.debut = dateTemp;
